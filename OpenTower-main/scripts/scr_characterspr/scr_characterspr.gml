function scr_characterspr() 
{
	...
	{
		global.panicmusicID = fmod_event_create_instance("event:/music/pizzatime");
	...
	{
		global.snd_voiceok = fmod_event_create_instance("event:/sfx/voice/noisepositive")
	  	global.panicmusicID = fmod_event_create_instance("event:/mod-music/anchovi");
	...
	{
		global.panicmusicID = fmod_event_create_instance("event:/music/pizzatime");
		global.snd_voiceok = fmod_event_create_instance("event:/sfx/voice/peppermansnicker")
	...
	if (character == "L")
	{
		spr_idle = spr_pizelleidle
		spr_move = spr_pizellewalk
		spr_crawl = spr_player_crawl
		spr_hurt = spr_player_hurt
		spr_jump = spr_pepperman_jump
		spr_jump2 = spr_pepperman_jump
	...
	if (character == "F")
	{
		spr_idle = spr_fakepeppino_idle
		spr_move = spr_fakepeppino_walk
		spr_crawl = spr_fakepeppino_crawl
		spr_hurt = spr_player_hurt
		spr_jump = spr_fakepeppino_jump
		spr_jump2 = spr_fakepeppino_jump
		spr_fall = spr_fakepeppino_fall
		spr_fall2 = spr_fakepeppino_fall
		spr_crouch = spr_player_crouch
		spr_crouchjump = spr_player_crouchjump
		spr_crouchfall = spr_player_crouchfall
		spr_couchstart = spr_player_couchstart
