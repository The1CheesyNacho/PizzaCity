function scr_player_pizzathrow(){
	...
	xscale = -1;
	jumpstop = 0;
	if (global.shroomfollow == 0 && global.cheesefollow == 0 && global.tomatofollow == 0 && global.sausagefollow == 0 && global.pineapplefollow == 0 && global.onionfollow ==  0)
	{
	    state = 0;
	    mach2 = 0;
	    image_index = 0;
	}
	if ((global.shroomfollow == 1 || global.cheesefollow == 1 || global.tomatofollow == 1 || global.sausagefollow == 1 || global.pineapplefollow == 1 || global.onionfollow == 1 ) && (!instance_exists(obj_toppinsacrifice)))
	{
