if (ready == 0)
{
	...
	if (selected == 0)
	{
		draw_sprite(spr_player1cursor, -1, 280, 20);
		if (global.coop == 1)
	...
	if (selected == 2)
	{
		draw_sprite(spr_player1cursor, -1, 509, 306);
		if (global.coop == 1)
	...
	if (selected == 3)
	{
		draw_sprite(spr_player1cursor, -1, 629, 164);
		if (global.coop == 1)
			draw_sprite(spr_player2cursor, -1, 344, 94);
		else if (gp_connected)
			draw_sprite(spr_player2cursor_start, -1, random_range(-1, 1) + 344, random_range(-1, 1) + 94);
...
else
{
		if (selected == 0)
	{
		draw_sprite(spr_player1cursorselected, -1, 280, 20);
		if (global.coop == 1)
	...
	if (selected == 2)
	{
		draw_sprite(spr_player1cursorselected, -1, 503, 9);
		if (global.coop == 1)
			draw_sprite(spr_player2cursorselected, -1, 344, 94);
	}
	if (selected == 3)
	{
		draw_sprite(spr_player1cursorselected, -1, 629, 164);
		if (global.coop == 1)
			draw_sprite(spr_player2cursorselected, -1, 344, 94);
	}
}
