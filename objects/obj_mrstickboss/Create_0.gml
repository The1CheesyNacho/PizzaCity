...
boss_array[0] = -4;
boss_array[1] = [obj_peppermanOLD, 1];
...
hp = max_hp;
stunfallspr = spr_stick_fall;
walkspr = spr_stick_idle;
idlespr = spr_stick_idle;
spr_dead = spr_stick_fall;
fallspr = spr_stick_fall;
bumpspr = spr_stick_fall;
defeatplayerspr = spr_stick_fall;
movespeed = 0;
move = 0;
normal_spd = 6;
helicopterspeed = 6;
