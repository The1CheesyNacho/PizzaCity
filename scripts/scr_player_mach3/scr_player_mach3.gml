	...
	switch (character)
	{
		...
		case "P":
			...
			if (sprite_index == spr_mach4 || sprite_index == spr_fightball)
				...
				image_speed = 0.4;
			if (((!key_attack && fightball == 0 && !launched) && sprite_index != spr_dashpadmach && grounded && vsp > 0 && (character == "P" || character == "N" || character == "PM")) || ((character == "S" && (move == 0 || move != xscale) && grounded) && fightball == 0))
			{
			...
			if (move == -xscale && grounded && vsp > 0 && !launched && (character == "P" || character == "N" || character == "PM") && fightball == 0 && sprite_index != spr_dashpadmach)
			{
